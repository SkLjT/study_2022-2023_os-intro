---
## Front matter
title: "Отчет по лабораторной работа №14"
...
1) Я создал каталог 14 и в нем создал файлы: client.c, client2.c,common.h,server.c. Взял пример с файла лабораторной работы и написал измененную программму, которая выполняет все нужные критерии.

![Код в файле client.c](/home/aalushin/work/study/study_2022-2023_os-intro/labs/lab14/report/image/Снимок экрана от 2023-05-02 20-35-29.png){#fig:001 width=70%}

![Код в файле client2.c](/home/aalushin/work/study/study_2022-2023_os-intro/labs/lab14/report/image/Снимок экрана от 2023-05-02 20-35-35.png){#fig:002 width=70%}

![Код в файле common.h](/home/aalushin/work/study/study_2022-2023_os-intro/labs/lab14/report/image/Снимок экрана от 2023-05-02 20-35-42.png){#fig:003 width=70%}

![Код в файле server.c](/home/aalushin/work/study/study_2022-2023_os-intro/labs/lab14/report/image/Снимок экрана от 2023-05-02 20-35-49.png){#fig:004 width=70%}

2) Создал файл Makefile для запуска файлов. Код взял в файле для лабораторной и немного изменил его.

![Код в файле Makefile](/home/aalushin/work/study/study_2022-2023_os-intro/labs/lab14/report/image/Снимок экрана от 2023-05-02 20-35-55.png){#fig:005 width=70%}

3) Прописал команду make для создания программ. Создалось две нужные программы.

![Создание программ](/home/aalushin/work/study/study_2022-2023_os-intro/labs/lab14/report/image/Снимок экрана от 2023-05-02 20-36-19.png){#fig:006 width=70%}
...
![Запуск программы](/home/aalushin/work/study/study_2022-2023_os-intro/labs/lab14/report/image/Снимок экрана от 2023-05-02 20-36-51.png){#fig:007 width=70%}
